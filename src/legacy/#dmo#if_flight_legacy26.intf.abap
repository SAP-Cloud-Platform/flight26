...
INTERFACE /dmo/if_flight_legacy26
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL26
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel26     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING26
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking26    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_26
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_26 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT26
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight26 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id26.
  ...
  TYPES booking_id TYPE /dmo/booking_id26.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id26.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL26, /DMO/BOOKING26, /DMO/BOOK_SUP_26 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code26.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code26,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status26,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel26_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id26.
  INCLUDE TYPE /dmo/booking26_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id26.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id26.
  INCLUDE TYPE /dmo/book_sup_26_data.
