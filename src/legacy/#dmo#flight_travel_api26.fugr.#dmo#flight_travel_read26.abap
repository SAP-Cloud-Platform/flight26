...
"! @parameter es_travel             | Travel Data like /DMO/TRAVEL26 related to the importing Travel ID
"! @parameter et_booking            | Table of Bookings like /DMO/BOOKING26 related to the importing Travel ID
"! @parameter et_booking_supplement | Table of Booking Supplements like /DMO/BOOK_SUP_26 related to the importing Travel ID
"! @parameter et_messages           | Table of occurred messages
"!
FUNCTION /DMO/FLIGHT_TRAVEL_READ26.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
*"     REFERENCE(IV_TRAVEL_ID) TYPE  /DMO/TRAVEL_ID26
...
*"----------------------------------------------------------------------
  ...
  /dmo/cl_flight_legacy26=>get_instance( )->get_travel( EXPORTING iv_travel_id          = iv_travel_id
