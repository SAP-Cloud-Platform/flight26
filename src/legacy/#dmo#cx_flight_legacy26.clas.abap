CLASS /dmo/cx_flight_legacy26 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_26',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_26',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id26 OPTIONAL
        booking_id            TYPE /dmo/booking_id26 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id26 OPTIONAL
        agency_id             TYPE /dmo/agency_id26 OPTIONAL
        customer_id           TYPE /dmo/customer_id26 OPTIONAL
        carrier_id            TYPE /dmo/carrier26-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_26-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_26-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date26 OPTIONAL
        end_date              TYPE /dmo/end_date26 OPTIONAL
        booking_date          TYPE /dmo/booking_date26 OPTIONAL
        flight_date           TYPE /dmo/flight_date26 OPTIONAL
        status                TYPE /dmo/travel_status26 OPTIONAL
        currency_code         TYPE /dmo/currency_code26 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id26,
          mv_booking_id            TYPE /dmo/booking_id26,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id26,
          mv_agency_id             TYPE /dmo/agency_id26,
          mv_customer_id           TYPE /dmo/customer_id26,
          mv_carrier_id            TYPE /dmo/carrier26-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_26-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_26-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date26,
          mv_end_date              TYPE /dmo/end_date26,
          mv_booking_date          TYPE /dmo/booking_date26,
          mv_flight_date           TYPE /dmo/flight_date26,
          mv_status                TYPE /dmo/travel_status26,
          mv_currency_code         TYPE /dmo/currency_code26,
...
CLASS /dmo/cx_flight_legacy26 IMPLEMENTATION.
